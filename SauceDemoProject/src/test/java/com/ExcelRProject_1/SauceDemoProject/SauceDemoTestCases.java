package com.ExcelRProject_1.SauceDemoProject;
...
import pageObjects.ChekOutCompletePage;
import pageObjects.ChekOutStepTwoPage;
...
public class SauceDemoTestCases {
	WebDriver driver;
	LoginPage lp; InventoryPage ip; CartPage cp;
	CheckOutStepOnePage csop; ChekOutStepTwoPage cstp;ChekOutCompletePage ccp;
	FooterPage fp;
	...
	public void initialisation() {
		...
		cstp = new ChekOutStepTwoPage(driver); ccp = new ChekOutCompletePage(driver);
	...
	public Object[][] validLoginData(){
		Object Data[][] = {{"standard_user","secret_sauce"},{"problem_user","secret_sauce"},{"performance_glitch_user"
			,"secret_sauce"},{"error_user","secret_sauce"},{"visual_user"
				,"secret_sauce"}};
		return Data;
	}
	...
	public void selectProductByHighToLow() {
		...
		System.out.println("****After Selection of High To Low****");
	...
	public void selectProductByLowToHigh() {
		...
		System.out.println("****After Selection of Low To High****");
		List<WebElement> ProductPriceAfter = ip.productPrices();
		for(int i = 0; i< ProductPriceAfter.size();i++) {
			System.out.println(ProductPriceAfter.get(i).getText());
		}
	...
	public void checkoutStepOnePageContinueBtnValidation() throws InterruptedException {
		...
		cp.clickOnCartIcon();
		cp.clickOnCheckout();
		csop.enterChecoutDetails("abc", "ghi", "452678");
